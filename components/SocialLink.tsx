import { SocialLink as SocialLinkData } from "@/data/developer";
...
const icons: Record<SocialLinkData["icon"], React.ReactNode> = {
    github: (
...
/** Social link with icon and hover animation */
